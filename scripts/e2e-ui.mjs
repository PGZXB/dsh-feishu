 ...
 *   2. prepares the exchange dir (_dev/e2e-exchange) + a writable setup.log
 ...
 *   E2E_EXCHANGE      exchange dir (default <repo>/_dev/e2e-exchange)
...
log('exchange', `scan-QR files + report land in ${exchange}`);
